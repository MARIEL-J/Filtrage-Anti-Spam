...
def transform_text(text):
    try:
        ...
        # 1. Traduction en anglais si la langue détectée n'est pas l'anglais
        if detected_lang != 'en':
